...
// MSPM0平台GPIO读取宏定义
#define KEY_key1() DL_GPIO_readPins(KEY_key1_PORT,KEY_key1_PIN)
#define KEY_key2() DL_GPIO_readPins(KEY_key2_PORT,KEY_key2_PIN)
#define KEY_key3() DL_GPIO_readPins(KEY_key3_PORT,KEY_key3_PIN)
#define KEY_key4() DL_GPIO_readPins(KEY_key4_PORT,KEY_key4_PIN)
#define KEY_key5() DL_GPIO_readPins(KEY_key5_PORT,KEY_key5_PIN)
...
typedef struct _KEY_Configure_TypeDef 
{
	...
	KEY_PinLevel_TypeDef          (*KEY_ReadPin_Fcn)(uint8_t data);  // 读取按键IO电平函数指针
